...
type
  ...
  private
    ...
    procedure GravaDados(sFornecedor : string; iCidade : Integer);
    procedure AlteraDados(sCodigoFornecedor : string; sFornecedor : string; iCidade : Integer);
...
procedure TfrmCadastroFornecedor.AlteraDados(sCodigoFornecedor, sFornecedor : string; iCidade : Integer);
var
...
begin
  try
    try
      ...
      qryAlteraDados.SQL.Add('        , tbFornecedor_Cidade = ' + IntToStr(iCidade));
...
begin
  try
    ...
    qryCarregaCombo.SQL.Add(' SELECT ');
  	qryCarregaCombo.SQL.Add('   c.Id, concat(c.nome,'' - '',e.UF) as Cidade ');
...
begin
  try
    ...
    qryConsultaRegistros.SQL.Add(' SELECT ');
  	qryConsultaRegistros.SQL.Add('   f.tbFornecedor_Id, f.tbFornecedor_Descricao, concat(c.nome,'' - '',e.UF) as Cidade ');
    qryConsultaRegistros.SQL.Add(' FROM ');
  	qryConsultaRegistros.SQL.Add('   tbFornecedor f');
    qryConsultaRegistros.SQL.Add('   INNER JOIN tbCidades c on c.id = f.tbFornecedor_Cidade');
    qryConsultaRegistros.SQL.Add('   INNER JOIN tbEstados e ON e.id = c.id_estado');
 	  qryConsultaRegistros.SQL.Add(' WHERE ');
    qryConsultaRegistros.SQL.Add('   f.tbFornecedor_Id = ' + QuotedStr(edtCodigoFornecedor.text));
    qryConsultaRegistros.SQL.Add(' ORDER BY ');
    qryConsultaRegistros.SQL.Add('  	f.tbFornecedor_Descricao');
    ...
    begin
      ...
      cmbCidade.ItemIndex      := cmbCidade.Items.IndexOf(qryConsultaRegistros.FieldByName('Cidade').AsString);
    end;
...
procedure TfrmCadastroFornecedor.GravaDados(sFornecedor : string; iCidade : Integer);
begin
  try
    try
      qryGravaDados.Close;
      ...
      qryGravaDados.SQL.Add('        ,' + IntToStr(iCidade));
